...
var server_prefix = configs.server_prefix || 'MASK';
/*
* ROUTER - The Router
*/
...
if(typeof configs.app_port === 'undefined'){
	var app_port = process.env.PORT || 1000;
}
else {
